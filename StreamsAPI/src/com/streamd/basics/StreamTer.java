...
public class StreamTer {
	...
	public static void main(String[] args) {
		...
		// collect,forEach,findFirst,reduce,iterator
		System.out.println("Using forEach");
		courses.forEach(str -> System.out.println(str));
		System.out.println();

		System.out.println("Using collect");
		List<String> ncourses = courses.stream().filter(str -> str.startsWith("J")).map(str -> str.toUpperCase())
		...
		courses.stream().sorted().forEach(str->System.out.println(str.toUpperCase()));
		System.out.println();
