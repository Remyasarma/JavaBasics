...
public interface IProductService {
	...
	List<String> getByBrandPrice(String brand,double price) throws ProductNotFoundException;
	List<String> getByProductNames(String productName) throws ProductNotFoundException;
